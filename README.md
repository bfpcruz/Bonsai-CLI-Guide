...
Bonsai CLI is available after the default [Bonsai installation](https://bonsai-rx.org/) . Before starting, make sure you can able to call ```Bonsai``` from your command line:
